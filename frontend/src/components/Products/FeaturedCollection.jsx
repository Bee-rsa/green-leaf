...
const faqs = [
  {
    ...
    answer:
      "Yes. Green Leaf operates as a private cannabis club, which means membership is required to purchase products. Membership is free and takes only a few minutes to set up in store. You'll need a valid South African ID and to be 18 or older.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We stock a range of CBD-dominant products including tinctures, capsules, and flower for members who want the therapeutic benefits of cannabis without significant psychoactive effects.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We do not currently offer online ordering or delivery. All purchases are made in store. This allows us to maintain the quality of our member experience and ensure every product leaves in perfect condition.",
  },
  {
    question: "Is cannabis legal in South Africa?",
    answer:
      "The private use and possession of cannabis by adults was decriminalised by the Constitutional Court in 2018. Green Leaf operates within a private club model in accordance with South African law. Our team can answer any questions you have about your rights as a member.",
  },
];
...
const FAQItem = ({ faq }) => {
  ...
  return (
    <div style={{ borderBottomColor: "rgba(255,255,255,0.15)" }} className="border-b last:border-none">
      <button
        onClick={() => setOpen(!open)}
        className="w-full flex items-center justify-between py-5 text-left group"
      >
        <span className={`font-heading text-lg leading-snug transition-colors duration-200 ${open ? "text-white" : "text-white/80 group-hover:text-white"}`}>
          {faq.question}
        </span>
        <span
        ...
        >
          <span className={`text-sm font-light transition-transform duration-300 ${open ? "rotate-45" : ""}`}>
            +
          </span>
        </span>
      </button>
...
const FeaturedCollection = () => {
  return (
    <section className="py-20 px-6" style={{ backgroundColor: "#C8A27A" }}>
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-14 gap-6">
          <div>
            ...
            <div className="w-8 h-px mt-5" style={{ backgroundColor: "rgba(255,255,255,0.4)" }} />
          </div>
        ...
        <div
          ...
          style={{ borderTopColor: "rgba(255,255,255,0.2)", borderTopWidth: "1px", borderTopStyle: "solid" }}
        >
          <p className="font-body text-sm text-white/70">
            Still have questions? We'd love to hear from you.
          </p>
          
           <a href="https://www.google.com/maps/place/Greenleaf+Cannabis+Club+Salt+Rock"
            target="_blank"
